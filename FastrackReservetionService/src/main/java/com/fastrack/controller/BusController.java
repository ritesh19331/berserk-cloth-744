...
public class BusController {
	...
	@PostMapping("/admin/bus/{key}")
	public ResponseEntity<Bus> addBusHandler(@RequestBody Bus bus,@PathVariable("key")	String key) throws BusException, AdminException{
	...
	public ResponseEntity<Bus> updateBusHandler(@RequestBody Bus bus,@PathVariable("key")	String key) throws BusException, AdminException{
